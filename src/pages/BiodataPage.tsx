        ...
        <div className="biodata-details">
          <div className="detail-card">
            ...
            <div className="detail-grid">
              <div className="detail-item"><span>Nama Lengkap</span><strong>Denta Adi Ramadhani</strong></div>
              <div className="detail-item"><span>NIM</span><strong>24090111</strong></div>
